...
`ha-addon/`, `ha-integration/`) owns its Makefile, container image or build
target, dependency pins, and tool config. Component Makefiles expose the same verbs where they
